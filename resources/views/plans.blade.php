      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm @if($plan->featured) border-primary" @endif>
          ...
          <div class="card-body">
            ...
            <button type="button" class="w-100 btn btn-lg btn-primary">subscripe</button>
          </div>
        </div>
      </div>
      @endforeach
...
<script src="{{asset('assets/js/bootstrap.bundle.min.js')}}" integrity="sha384-HwwvtgBNo3bZJJLYd8oVXjrBZt8cqVSpeBNS5n7C8IVInixGAoxmnlMuBnhbgrkm" crossorigin="anonymous"></script>
